...
const CustomerDetails: React.FC<CustomerDetailsProps> = () => {
  ...
  const products = customer?.purchasedProducts?.filter(
    (product) =>
    ...
    <div className="mt-4 bg-white dark:bg-slate-700 dark:text-white rounded shadow-xl p-4">
      ...
      <div className={"mt-10"}>
        ...
        <div className={"flex justify-center"}>
          <div
            className={
              "min-w-[800px] bg-white mt-4 p-4 rounded space-y-2 flex flex-col items-center"
            }
          >
            <TextArea
              className={"w-full"}
      ...
      <div>
        ...
        <Table
          rowKey={(obj: Product) => obj.id}
          dataSource={customer?.returnedProducts}
          rowClassName={
            "dark:bg-slate-700 dark:text-white dark:hover:text-primaryColor-900"
          }
        >
